...
public class Base_Test {
	//As we need to access these into another package all the objects are declared public
	...
	public void beforeTest()
	{
		...
		spark = new ExtentSparkReporter(FrameWorkConstantss.reportsPath);
	...
	public void beforeMethod() throws IOException
	{
		...
		loginPage.getPasswordField().sendKeys(fileUtility.readDataFromPropertyFile("password"));
